...
module.exports.getAlbaranesAgente = function (codagent, callback) {
    ...
    sql += " LEFT JOIN sagent AS ag ON ag.codagent = cab.codagent"
    if (codagent) {
        sql += " WHERE cab.codagent = ?";
    }
    sql += " ORDER BY cab.fechaalb DESC, cab.codtipom ,cab.numalbar;";
