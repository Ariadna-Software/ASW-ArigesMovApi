    ...
    async.parallel([
        function(callback2) {
            ...
            ofertasMysql.getOfertasCliente(codclien, function(err, result) {
                ...
                return callback2(null, numOfertas);
            });
        },
        function(callback2) {
            ...
            pedidosMysql.getPedidosCliente(codclien, function(err, result) {
                ...
                return callback2(null, numPedidos);
            });
        ...
        function(callback2) {
            ...
            albaranesMysql.getAlbaranesCliente(codclien, function(err, result) {
                ...
                return callback2(null, numAlbaranes);
            });
        },
        function(callback2) {
        ...
        return callback(null, indicadores);
    });
};
